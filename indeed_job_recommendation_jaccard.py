...
from skill_keyword_match import skill_keyword_match,get_cosine_similarity,Jaccard_Similarity
...
def main():
    ...
    #print(Y_true)
        ...
        for f in config.IT_JOBS:
            ...
            for i in jobs_info:
                list_sim.append({'job':f,"similarity":Jaccard_Similarity(resume_text, i['desc'])})
        print(list_sim)
